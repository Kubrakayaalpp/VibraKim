...
using VibraKimWeb.DAL.Contexts;

namespace KubraKayaalp.Areas.admin.Controllers
{
    [Authorize]
    public class SliderController : Controller
    {
        ...
        public ActionResult Edit([Bind(Include = "ID,Picture,Title,SubTitle,Description,CategoryLink,ProductLink,Price,PIndex")] Slider slider)
        {
            if (ModelState.IsValid)
            {
